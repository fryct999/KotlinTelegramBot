...
class LearnWordsTrainerTest {
    ...
    fun `test statistics with 4 words of 7`() {
        val trainer = LearnWordsTrainer(
            wordsFileName = "src/test/4_words_of_7.txt",
            chatId = 0,
            username = "Test",
        )
        assertEquals(
    ...
    fun `test getNextQuestion() with 1 unlearned word`() {
        val trainer = LearnWordsTrainer(
            wordsFileName = "src/test/1_unlearned_word.txt",
            chatId = 0,
            username = "Test",
        )
        assertEquals(
    ...
    fun `test getNextQuestion() with 5 unlearned words`() {
        val trainer = LearnWordsTrainer(
            wordsFileName = "src/test/5_unlearned_word.txt",
            chatId = 0,
            username = "Test",
        )
        assertEquals(
    ...
    fun `test getNextQuestion() with all words learned`() {
        val trainer = LearnWordsTrainer(
            wordsFileName = "src/test/7_words_of_7.txt",
            chatId = 0,
            username = "Test",
        )
    ...
    fun `test resetProgress() with 2 words in dictionary`() {
        val trainer = LearnWordsTrainer(
            wordsFileName = "src/test/1_words_of_2.txt",
            chatId = 0,
            username = "Test",
        )
        assertEquals(
    ...
    fun `test statistics with corrupted file`() {
        val trainer = LearnWordsTrainer(
            wordsFileName = "src/test/corrupted_file.txt",
            chatId = 0,
            username = "Test",
        )
        assertEquals(
